...
class Parser:
    ...
    def parse_statement(self):
        ...
        if self.current is not None and self.current.type == TokenType.KEYWORD:
            extended = {
                ...
                "KEYS","VALUES","ENTRIES","HAS","PROPERTY","PROP","REGEX","PATTERN","MATCH","ENUM","STRUCT","UNION","GENERATOR","NEXT","ITERATOR","DESTRUCTURE","SPREAD","REST","PROMISE","ASYNC","AWAIT","ASSERT","DEBUG","WARN","ERROR","DUMP","DISASM","NOP","NOOP"
            }
    ...
    def parse_builtin_statement(self):
        ...
        arity = {
            ...
            "EQ":2,"NE":2,"LT":2,"LE":2,"GT":2,"GE":2,"AND":2,"OR":2,"XOR":2,"NAND":2,"NOR":2,
            "BITAND":2,"BITOR":2,"BITXOR":2,"LSHIFT":2,"RSHIFT":2,"ROTL":2,"ROTR":2,
            "ABS":1,"SQRT":1,"EXP":1,"LN":1,"LOG":1,"LOG10":1,"SIN":1,"COS":1,"TAN":1,
            "ASIN":1,"ACOS":1,"ATAN":1,"FLOOR":1,"CEIL":1,"ROUND":1,"TRUNC":1,"SIGN":1,"FAC":1,
            "NOT":1,"BITNOT":1,"TYPE_OF":1,"TYPEOF":1,"INT":1,"FLOAT":1,"BOOL":1,"STRINGIFY":1,
            "NUMBER":1,"CHAR":1,"STR":1,"TEXT":1,"UPPER":1,"LOWER":1,"TRIM":1,"REVERSE":1,
            "LENGTH":1,"SIZE":1,"FIRST":1,"LAST":1,"POP":1,"SHIFT":1,"JSON":1,"PARSE_JSON":1,
            "STRINGIFY_JSON":1,"HASH":1,"MD5":1,"SHA":1,"SHA1":1,"SHA256":1,"SHA512":1,"BASE64":1,
            "ENCODE64":1,"DECODE64":1,"DECODE":1,"HEX":1,"TIME":0,"TIMESTAMP":0,"VERSION":0,
            "RANDOM":0,"SLEEP":1,"ARGV":0,"GETPID":0,"SYSTEMOS":0,"PLATFORM":0,"ARCH":0,
        }.get(name)
        if arity is None:
