...
class OpCode:
    ...
    _NAMES = {
        ...
        485: "VERSION_CHECK", 486: "FEATURE_CHECK", 487: "PRAGMA", 488: "INLINE", 489: "RETHROW", 490: "JMP_IF_ITER_END",
...
NATIVE_IDS = {
    name: i + 1 for i, name in enumerate([
        ...
        "CHARAT","STR_INDEXOF","ISDIGIT","ISLETTER","ISSPACE","ISALNUM",
        "ASCII","SOURCE_LINE","ERROR_AT","WARNING",
        "READ_BYTES","WRITE_BYTES","PACK_INT","UNPACK_INT",
        "PATH_NORMALIZE","BASENAME","DIRNAME","EXTENSION",
        "READ_LINES","FILE_LINES",
        # V2.0.5 self-hosting core
        "READ_FILE","WRITE_FILE","PATH_JOIN","PATH_DIR","PATH_NAME",
        "CHAR_AT","ORD","CHR","TO_STRING","TO_INT","PARSE_INT","PARSE_FLOAT",
        "TYPEOF","IS","STRUCT_NEW","VISIT","PACK","UNPACK"
    ])
}
